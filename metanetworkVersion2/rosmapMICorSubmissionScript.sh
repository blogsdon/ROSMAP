...
s3="s3://metanetworks/ROSMAP/"

#location of data file
dataFile="/shared/ROSMAP/cranioRNAseq.csv"

#location of metanetwork synapse scripts
pathv="/shared/metanetworkSynapse/"

#output path for temporary result file prior to pushing to s3/synapse
outputpath="/shared/ROSMAP/"
...
annotationFile="/shared/ROSMAP/annoFile.txt"

#path to csv file with provenance to add to file on synapse
provenanceFile="/shared/ROSMAP/provenanceMICorFile.txt"

#path to error output
errorOutput="/shared/ROSMAP/marginalerror.txt"

#path to out output
outOutput="/shared/ROSMAP/marginalout.txt"

#job script name
jobname="rosmapMarginal"
