...
provenanceFile="/shared/ROSMAP/metanetworkV2/MCI/provenanceFileMICor.txt"

#path to error output
errorOutput="/shared/ROSMAP/metanetworkV2/MCI/marginalerror.txt"

#path to out output
outOutput="/shared/ROSMAP/metanetworkV2/MCI/marginalout.txt"
