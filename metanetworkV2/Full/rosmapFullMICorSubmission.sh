...
provenanceFile="/shared/ROSMAP/metanetworkV2/Full/provenanceFileMICor.txt"

#path to error output
errorOutput="/shared/ROSMAP/metanetworkV2/Full/marginalerror.txt"

#path to out output
outOutput="/shared/ROSMAP/metanetworkV2/Full/marginalout.txt"
