...
provenanceFile="/shared/ROSMAP/metanetworkV2/AD/provenanceFileRegression2.txt"

#path to error output
errorOutput="/shared/ROSMAP/metanetworkV2/AD/Regressionerror2.txt"

#path to out output
outOutput="/shared/ROSMAP/metanetworkV2/AD/Regressionout2.txt"
