...
provenanceFile="/shared/ROSMAP/reprocessed/MCI/provenanceFileMICor.txt"

#path to error output
errorOutput="/shared/ROSMAP/reprocessed/MCI/marginalerror.txt"

#path to out output
outOutput="/shared/ROSMAP/reprocessed/MCI/marginalout.txt"
