...
provenanceFile="/shared/ROSMAP/reprocessed/AD/provenanceFileRegression2.txt"

#path to error output
errorOutput="/shared/ROSMAP/reprocessed/AD/Regressionerror2.txt"

#path to out output
outOutput="/shared/ROSMAP/reprocessed/AD/Regressionout2.txt"
