...
provenanceFile="/shared/ROSMAP/reprocessed/AD/provenanceFileRegression.txt"

#path to error output
errorOutput="/shared/ROSMAP/reprocessed/AD/Regressionerror.txt"

#path to out output
outOutput="/shared/ROSMAP/reprocessed/AD/Regressionout.txt"
