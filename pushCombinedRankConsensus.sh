...
../metanetworkSynapse/pushNet.sh -a "syn4545002" -b "/shared/ROSMAP/codeFile.txt" -c "/shared/ROSMAP/synFile.txt" -z -r "None" -s "HomoSapiens" -t "NCI_MCI_AD" -u "DLPFC" -x "/shared/metanetworkSynapse/pushSparseNetworkSynapse.R"
