...
/shared/metanetworkSynapse/pushNet.sh -a "syn4545013" -b "/shared/ROSMAP/codeMCI.txt" -c "/shared/ROSMAP/syn.txt" -z -r "None" -s "HomoSapiens" -t "MCI" -u "DLPFC" -x "/shared/metanetworkSynapse/pushSparseNetworkSynapse.R"