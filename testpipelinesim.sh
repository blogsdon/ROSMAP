...
qsub -v dataFile="../ROSMAP/data.csv",pathv="/shared/metanetworkSynapse/ARACNE/",aracne=1,aracneFull=1,numberCore=1,outputpath="/shared/testNet/" -pe orte 1 buildNet.sh
